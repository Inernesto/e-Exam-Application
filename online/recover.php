...
<div class="row header">
		...
		<div class="col-xs-10 col-sm-10 col-md-6" style="padding-left:50px;">
	...
	<div class="col-xs-2 col-sm-2 col-md-2 col-md-offset-4" style="padding-left:50px;">
...
<div class="row bg1">
	...
	<div class="row forgot-fix" style="padding-left:25px;">

		<div class="col-xs-1 col-sm-3 col-md-3">
		</div>

		<div class="col-xs-10 col-sm-6 col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:200px;">
...
?>
			...
			<h2 class="text-center" style="font-family:'typo'; color:#000066">PLEASE RE-SET YOUR PASSWORD BELOW</h2>
			...
			<div style="font-size:14px">
				...
				<form role="form"  method="post" action="login.php">
					...
					<div class="row">
						...
						<!-- Text input-->
							<div class="form-group">
								  ...
								  <input id="password" name="password" placeholder="Please Enter Your Password" class="form-control input-md" type="password">
								  
								  <input id="confirm_password" name="confirm_password" placeholder="Please Confirm Your Password" class="form-control input-md" type="password">
								  
								  <input id="email" type="hidden" name="email" value="<?php echo $email; ?>">
								  
								  <input id="validation_code" type="hidden" name="validation_code" value="<?php echo $validation_code; ?>">
					...
					<div class="form-group" align="right">
						...
						<input type="submit" name="recover_password" value="Re-set Password" class="btn btn-primary">
